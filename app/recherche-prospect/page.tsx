...
export default function RechercheProspectPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                <h2 className="text-3xl font-bold tracking-tight">Recherche Prospect</h2>
                <p className="text-muted-foreground">Lancez une nouvelle recherche de prospects sur Google Maps.</p>
            </div>
